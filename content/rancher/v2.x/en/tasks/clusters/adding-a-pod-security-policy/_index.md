...
1. From the **Global** view, find the cluster that you want apply your PSP to. Select **Vertical Ellipsis (...) > Edit** for the cluster you want to enable PSPs for.
...
1. From the **Global** view, find to the cluster containing the project you want to apply a PSP to.
