...
>**Note:** This step only applies to nodes hosted on cloud-hosted virtual machines. If you're using on-premise virtual machines or bare-metal servers, skip ahead to [4. Add Linux Host for Ingress Support](#4-add-linux-host-for-ingress-support).
